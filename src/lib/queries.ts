...
import type { TarotCardRow } from '@/types/database.types';

// ============================================================
// Data Access Layer — Truy vấn dữ liệu Tarot từ Supabase
// ============================================================
...
export async function getAllCards(): Promise<TarotCardRow[]> {
  const { data, error } = await supabase
    .from('tarot_cards')
    .select('*')
    .order('arcana', { ascending: true })     // major trước minor
 ...
 * Supabase không hỗ trợ RANDOM trực tiếp nên fetch all rồi shuffle
 */
